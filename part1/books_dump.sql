...
INSERT INTO `BookInfo` VALUES (1,'Introduction to Algorithms','Thomas H. Cormen','19780262033848'),(2,'Introduction to Algorithms','Thomas H. Cormen','19780262033848');
...
INSERT INTO `BookListings` VALUES (3,2,2,79.95,'Good','2025-06-19');
...
INSERT INTO `Locations` VALUES (1,'Adelaide','SA','Australia'),(2,'Adelaide','SA','Australia');
...
CREATE TABLE `Purchases` (
  `PurcaseID` int NOT NULL AUTO_INCREMENT,
  `BuyerID` int NOT NULL,
  `BookID` int NOT NULL,
  `PurchaseDate` date NOT NULL,
  PRIMARY KEY (`PurcaseID`),
  KEY `BuyerID` (`BuyerID`),
  KEY `BookID` (`BookID`),
...
INSERT INTO `Users` VALUES (2,'Alice Johnson','alice@example.com','hashedpassword123',1);
...
-- Dump completed on 2025-06-19  7:17:15
